...
class Ipaymu extends curl_1.default {
    ...
    async redirectPayment(paymentData) {
        ...
        return await this.request(__classPrivateFieldGet(this, _Ipaymu_config, "f").redirectpayment, {
            ...
            returnUrl: __classPrivateFieldGet(this, _Ipaymu_ureturn, "f"),
            cancelUrl: __classPrivateFieldGet(this, _Ipaymu_ucancel, "f"),
            weight: cart.weight,
            dimension: cart.dimension,
            name: __classPrivateFieldGet(this, _Ipaymu_buyer, "f")?.name,
            email: __classPrivateFieldGet(this, _Ipaymu_buyer, "f")?.email,
            phone: __classPrivateFieldGet(this, _Ipaymu_buyer, "f")?.phone,
            ...
            buyerName: __classPrivateFieldGet(this, _Ipaymu_buyer, "f")?.name,
            buyerEmail: __classPrivateFieldGet(this, _Ipaymu_buyer, "f")?.email,
            buyerPhone: __classPrivateFieldGet(this, _Ipaymu_buyer, "f")?.phone,
